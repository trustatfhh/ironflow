...
public class ThreadSafeSsrc implements SSRC {
	...
	/**
	 * Creates a new thread safe {@link SSRC} based on user authentication.
	 * 
	 * @param url
	 ...
	 *             if library cannot be initialized
	 */
	...
	/**
	 * Creates a new thread safe {@link SSRC} based on key manager.
	 * 
	 * @param url
	 *            the url to connect to
	 * @param kms
